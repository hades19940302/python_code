...
headers = {
	...
	'Cookie': 'IKUT=7648; BAIDUID=D36E55B433347B48F9BFE6BD1CB48B62:FG=1; BIDUPSID=D36E55B433347B48F9BFE6BD1CB48B62; PSTM=1521028828; BDORZ=AE84CDB3A529C0F8A2B9DCDD1D18B695; Hm_lvt_16bc67e4f6394c05d03992ea0a0e9123=1522043798,1522043803,1522043815,1522043824; H_PS_PSSID=1446_21101_22158; PSINO=2; Hm_lvt_6859ce5aaf00fb00387e6434e4fcc925=1522034988,1522038758,1522043786,1522043985; Hm_lpvt_6859ce5aaf00fb00387e6434e4fcc925=1522046136',
...
def test(xxxx):
	f1 = open('baiduzhidao_url_list_99.txt','rb')
	i = 1
	for url in f1.readlines():
		id_ = url[34:-7]
		url = 'https://zhidao.baidu.com/question/91145209.html'
		id_ = '91145209'
		if id_ not in id_list:
			...
			html = re.sub(r'<br[ ]?/?>', '\n', html)
			with codecs.open('zhidao_6666.txt','a+','utf-8') as f:
				f.write(r.content)
				f.close()
			print(html)
				...
				if like ==[]:
					...
					if like[0] == '0' or like[0] == 0:
						...
						if answers == []:
							...
							with codecs.open('zhidao_question_to_answer_99.txt','a+','utf-8') as f:
			...
			for r_question_list_title in r_question_list_titles:
				...
				with codecs.open('zhidao_question_to_question_99.txt','a+','utf-8') as f1:
					if desc == '':
