...
# author=hades
# 实现爬虫驾照考试题
# URL地址：http://www.ccyp.com/home/drivingtest?gclid=CjwKEAjwhrzLBRC35--F9sSH0FASJAD5obJ1FgzkZlm-0fKJACOXWBnF_OjYEXm5Pw1s7h_ZEbwW_BoC80vw_wcB
# 这个是取所有题目的B选项
...
def test():
	...
	# all_divs = soup.find_all('div',class_='row-fluid q-answer')
